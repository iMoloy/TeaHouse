...
declare const admin: <O extends AdminOptions>(options?: O | undefined) => {
  ...
  hooks: {
    after: {
      ...
      handler: import("better-call").Middleware<import("better-call").MiddlewareOptions, (inputContext: import("better-call").MiddlewareInputContext<import("better-call").MiddlewareOptions>) => Promise<SessionWithImpersonatedBy[] | undefined>>;
    }[];
  };
  endpoints: {
