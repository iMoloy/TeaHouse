...
declare function getEndpoints<Option extends BetterAuthOptions>(ctx: Awaitable<AuthContext>, options: Option): {
  api: OverrideMerge<{
    ...
    readonly signUpEmail: import("better-call").StrictEndpoint<"/sign-up/email", {
      method: "POST";
      operationId: string;
      use: Middleware<import("better-call").MiddlewareOptions, (inputContext: import("better-call").MiddlewareInputContext<import("better-call").MiddlewareOptions>) => Promise<void>>[];
    ...
    readonly verifyPassword: import("better-call").StrictEndpoint<"/verify-password", {
      ...
      use: Middleware<import("better-call").MiddlewareOptions, (inputContext: import("better-call").MiddlewareInputContext<import("better-call").MiddlewareOptions>) => Promise<{
        session: {
